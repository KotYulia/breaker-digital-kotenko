...
function breaker_setup() {
	...
	register_nav_menus( array(
		'main-nav' => esc_html__( 'Primary', 'breaker' ),
	) );
...
add_action( 'wp_enqueue_scripts', 'breaker_scripts', 'load_style', 'enqueue_font_awesome' );
...
/**
 * Load films-directors file.
 */
require get_template_directory() . '/inc/films-directors.php';

//LOGO
add_theme_support( 'custom-logo' );

//Delete <p> in 'the_excerpt'
add_filter('the_excerpt', 'remove_img_ptags_func');
